[prodeskel-node-ts](../README.md) / [Exports](../modules.md) / [<internal\>](../modules/internal_.md) / [internal](../modules/internal_.internal.md) / PassThrough
...
▸ **destroy**(`error?`): [`PassThrough`](internal_.internal.PassThrough.md)
